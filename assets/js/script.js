...
$(".list-group").on("change", "input[type='text']", function () {
  ...
  //update the task in the array and resave it into local storage
  ...
  //replace the input with the span element
...
$(".card .list-group").sortable({
  ...
  update: function (event) {
    ...
    //loop over the curretn set of children in the sortable list
...
//using the jquery ui datepicker widget to update the date in the modal
